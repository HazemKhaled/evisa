...
describe('Sitemap Routes', () => {
  describe('GET /sitemap_index.xml', () => {
    it('should return sitemap index XML', async () => {
      const { generateSitemapIndex, generateSitemapIndexXml } = require('@/lib/sitemap');
      
      const mockSitemaps = [
        { url: 'https://gettravelvisa.com/sitemap.xml', lastmod: '2024-01-01T00:00:00.000Z' },
        { url: 'https://gettravelvisa.com/d/usa/sitemap.xml', lastmod: '2024-01-01T00:00:00.000Z' },
      ];
      ...
      const request = new NextRequest('https://gettravelvisa.com/sitemap_index.xml');
    ...
    it('should handle errors gracefully', async () => {
      const { generateSitemapIndex } = require('@/lib/sitemap');
  ...
  describe('GET /sitemap.xml', () => {
    it('should return main sitemap XML', async () => {
      const { generateMainSitemap, generateSitemapXml } = require('@/lib/sitemap');
      
      const mockUrls = [
        { url: 'https://gettravelvisa.com', priority: '1.0', changefreq: 'daily' },
        { url: 'https://gettravelvisa.com/contact', priority: '0.8', changefreq: 'monthly' },
      ];
    ...
    it('should handle errors gracefully', async () => {
      const { generateMainSitemap } = require('@/lib/sitemap');
  ...
  describe('GET /d/[country]/sitemap.xml', () => {
    it('should return destination sitemap XML', async () => {
      const { generateDestinationSitemap, generateSitemapXml } = require('@/lib/sitemap');
      
      const mockUrls = [
        { url: 'https://gettravelvisa.com/d/usa', priority: '1.0', changefreq: 'daily' },
        { url: 'https://gettravelvisa.com/d/usa/v/tourist-visa', priority: '0.8', changefreq: 'monthly' },
      ];
      const mockXml = '<?xml version="1.0" encoding="UTF-8"?><urlset>...</urlset>';
      ...
      const request = new NextRequest('https://gettravelvisa.com/d/usa/sitemap.xml');
      const response = await getDestinationSitemap(request, { params: { country: 'usa' } });
    ...
    it('should return 404 for non-existent country', async () => {
      const { generateDestinationSitemap } = require('@/lib/sitemap');
      
      generateDestinationSitemap.mockResolvedValue([]);

      const request = new NextRequest('https://gettravelvisa.com/d/invalid/sitemap.xml');
      const response = await getDestinationSitemap(request, { params: { country: 'invalid' } });
  ...
  describe('GET /robots.txt', () => {
    it('should return robots.txt for production', async () => {
      ...
      expect(text).toContain('Sitemap: https://gettravelvisa.com/sitemap_index.xml');
  ...
  describe('GET /manifest.json', () => {
    it('should return manifest.json', async () => {
      const request = new NextRequest('https://gettravelvisa.com/manifest.json');
