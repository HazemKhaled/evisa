-- Comprehensive Data Dump for GetTravelVisa.com
-- Generated from backup data migrations
...
-- Insert countries data with conflict resolution-- Insert countries data with conflict resolution
-- Total countries: 192
...
('europe-festivals-seasonal-events', 'Sophie Dubois', 'DEU,FRA,ITA,ESP,GBR', 'tourist,business', 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-25 00:00:00', true, now(), now()),
('europe-transportation-travel-tips', 'Marco Rossi', 'DEU,FRA,ITA,ESP,GBR', 'tourist,business', 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80', '2024-11-28 00:00:00', true, now(), now()),
...
('japan-cultural-experiences-travel-guide', 'Kenji Yamamoto', 'JPN', 'tourist,cultural', 'https://images.unsplash.com/photo-1545569341-9eb8b30979d9?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-15 00:00:00', true, now(), now()),
('japan-food-guide-culinary-journey', 'Yuki Tanaka', 'JPN', 'tourist,culinary', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-18 00:00:00', true, now(), now()),
...
('multi-country-europe-guide', 'Pierre Dubois', 'DEU,FRA,ITA,ESP,GBR', 'tourist,schengen', 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-22 00:00:00', true, now(), now()),
('saudi-arabia-cultural-desert-adventures', 'Khalid Al-Nasser', 'SAU', 'tourist,business', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-15 00:00:00', true, now(), now()),
('saudi-arabia-historical-sites-guide', 'Hassan Al-Rashid', 'SAU', 'tourist,business', 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-22 00:00:00', true, now(), now()),
('saudi-arabia-modern-cities-guide', 'Nora Al-Zahra', 'SAU', 'tourist,business', 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-18 00:00:00', true, now(), now()),
('saudi-arabia-vision-2030-tourism-guide', 'Abdullah Al-Saud', 'SAU', 'tourist,business', 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-20 00:00:00', true, now(), now()),
('schengen-visa-requirements', 'Klaus Mueller', 'DEU,FRA,ITA,ESP', 'tourist,business,transit', 'https://images.unsplash.com/photo-1467269204594-9661b134dd2b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80', '2024-11-20 00:00:00', true, now(), now()),
('scotland-highlands-adventure-guide', 'Fiona MacLeod', 'GBR', 'tourist,visitor', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-26 00:00:00', true, now(), now()),
('uae-abu-dhabi-culture-guide', 'Layla Al-Mansouri', 'ARE', 'tourist,business', 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-23 00:00:00', true, now(), now()),
('uae-desert-adventures-guide', 'Omar Al-Rashid', 'ARE', 'tourist,business', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-25 00:00:00', true, now(), now()),
('uae-dubai-attractions-guide', 'Ahmed Hassan', 'ARE', 'tourist,business', 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-28 00:00:00', true, now(), now()),
('uae-food-dining-culture-guide', 'Fatima Al-Zahra', 'ARE', 'tourist,business', 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-12-01 00:00:00', true, now(), now()),
('uk-cultural-heritage-guide', 'Charlotte Davies', 'GBR', 'tourist,visitor', 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-28 00:00:00', true, now(), now()),
('uk-food-pub-culture-guide', 'James Wilson', 'GBR', 'tourist,visitor', 'https://images.unsplash.com/photo-1513475382585-d06e58bcb0e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-12-05 00:00:00', true, now(), now()),
('uk-visa-application-tips', 'Oliver Brown', 'GBR', 'tourist,visitor', 'https://images.unsplash.com/photo-1554224155-6726b3ff858f?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-25 00:00:00', true, now(), now()),
('usa-cities-urban-experiences-guide', 'David Thompson', 'USA', 'tourist,esta,visitor', 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-12-10 00:00:00', true, now(), now()),
('usa-food-culture-regional-guide', 'Emily Rodriguez', 'USA', 'tourist,esta,visitor', 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-12-08 00:00:00', true, now(), now()),
('usa-national-parks-adventure-guide', 'Michael Chen', 'USA', 'tourist,esta,visitor', 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-12-15 00:00:00', true, now(), now()),
('usa-road-trip-planning-guide', 'Sarah Johnson', 'USA', 'tourist,esta,visitor', 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-12-20 00:00:00', true, now(), now()),
('usa-tourist-visa-b2-guide', 'Carlos Rodriguez', 'USA', 'tourist,visitor', 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-20 00:00:00', true, now(), now()),
('visa-usa-turista', 'Carlos Rodriguez', 'USA', 'tourist,visitor', 'https://images.unsplash.com/photo-1488646953014-85cb44e25828?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80', '2024-11-20 00:00:00', true, now(), now())
ON CONFLICT (slug) DO NOTHING;

-- ==================================================
-- BLOG POSTS I18N (Multilingual translations)
-- ==================================================
...
-- ==================================================
-- VISA TYPES I18N (Multilingual translations)
-- ==================================================
...
-- ==================================================
-- VISA ELIGIBILITY (32+ eligibility rules)
-- ==================================================
...
-- ==================================================
-- VISA ELIGIBILITY I18N (Multilingual translations)
-- ==================================================
