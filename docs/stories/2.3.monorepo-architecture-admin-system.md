...
- [x] Create apps/admin Next.js application (AC: 1, 3, 4)
  ...
  - [x] Build CRUD interface for Countries (scaffolded)
    - [ ] List view with pagination and search (full implementation)
    - [ ] Create/Edit form with validation (full implementation)
    - [ ] Delete functionality with confirmation (full implementation)
  - [x] Build CRUD interface for Visa Types (scaffolded)
    - [ ] List view with destination filtering (full implementation)
    - [ ] Create/Edit form with destination relationship (full implementation)
    - [ ] Delete functionality (full implementation)
  - [x] Build CRUD interface for Visa Eligibility (scaffolded)
    - [ ] Many-to-many relationship management (full implementation)
    - [ ] Bulk operations support (full implementation)
  - [x] Build CRUD interface for Blog Posts (scaffolded)
    - [ ] MDX content editor or rich text editor (full implementation)
    - [ ] Destination and tag associations (full implementation)
    - [ ] Publish/draft status management (full implementation)
...
- [x] Update deployment configurations (AC: 5)
  ...
  - [ ] Test manual deployments
    - [ ] Test website production deployment
