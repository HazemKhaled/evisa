...
- [ ] Create blog routing structure (AC: 1, 2, 3)
  - [ ] Create `/src/app/[locale]/blog/page.tsx` for main blog listing
  - [ ] Create `/src/app/[locale]/blog/[slug]/page.tsx` for individual posts
  - [ ] Create `/src/app/[locale]/blog/t/[tag]/page.tsx` for tag-based filtering
  - [ ] Create `/src/app/[locale]/d/[destination]/blog/page.tsx` for destination-specific blogs
  - [ ] Implement proper TypeScript interfaces for blog route params and props

- [ ] Implement MDX content processing system (AC: 4)
  - [ ] Set up gray-matter for frontmatter parsing in blog posts
  - [ ] Create blog content processing utilities in `/src/lib/blog.ts`
  - [ ] Implement blog post metadata extraction (title, description, date, tags, destination)
  - [ ] Add support for multilingual blog content structure in `/src/contents/[locale]/blog/`
  - [ ] Create blog post validation and error handling

- [ ] Build blog UI components (AC: 1, 5)
  - [ ] Create BlogPostCard component for listing pages
  - [ ] Build BlogPostDetail component for individual post pages
  - [ ] Implement BlogPostList component with pagination support
  - [ ] Create RelatedArticles component for destination page integration
  - [ ] Add blog search functionality with filtering capabilities

- [ ] Implement blog service layer (AC: 2, 3, 5)
  - [ ] Create blog data fetching functions in `/src/lib/services/blog-service.ts`
  - [ ] Implement getBlogPosts function with filtering and pagination
  - [ ] Add getBlogPostsByDestination function for destination-specific filtering
  - [ ] Create getBlogPostsByTag function for tag-based filtering
  - [ ] Add getRelatedBlogPosts function for destination page integration
