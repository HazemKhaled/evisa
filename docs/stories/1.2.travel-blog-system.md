...
**I want** destination-focused blog content and filtering capabilities, \*_so that_### Change Log
...
- [x] Add blog search functionality with filtering- [x] Implement blog service layer (AC: 2, 3, 5)
...
- [ ] Add multilingual blog support (AC: 1, 2, 3, 4)
  - [ ] Implement blog post translations structure for all 8 supported languages
  - [ ] Add blog-specific translation keys to i18n files
  - [ ] Ensure blog navigation and UI elements support RTL languages
  - [ ] Test blog functionality across all supported locales

- [ ] Homepage blog integration (AC: 5)
  - [ ] Update homepage "Latest Posts" section to use new blog system
  - [ ] Implement blog post previews on homepage with proper linking
  - [ ] Ensure homepage blog integration maintains existing design patterns
  - [ ] Test blog post loading and display on homepage
